...
Provides a checklist implementation using the Checklist model from agents.
"""
...
if TYPE_CHECKING:
    from core.agents.spec.checklist_models import Checklist
    from core.agents.enum import ChecklistStatus
